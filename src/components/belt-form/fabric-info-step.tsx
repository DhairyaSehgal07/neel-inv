              ...
              {fabricCalculationValues && (
                <div className="mt-2 p-3 bg-muted/50 rounded-md text-sm space-y-1">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      Belt Length:{' '}
                      <span className="font-medium">{fabricCalculationValues.beltLengthM} m</span>
                    </div>
                    <div>
                      Number of Plies:{' '}
                      <span className="font-medium">{fabricCalculationValues.numberOfPlies}</span>
                    </div>
                    <div className="col-span-2">
                      Factor: <span className="font-medium">{fabricCalculationValues.factor}</span>
                    </div>
                  </div>
                </div>
              )}
